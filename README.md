<!-- # Future TODOs
- Could also add STEP files (not just STL)
- Eventually add a White Paper or publication for the system validation
-->
...
a pair of functional headphones that can also record EEG, EMG, and ECG.
...
| 2      | Ear Cushions (70mm diameter)                                         | Available, e.g. at: https://de.aliexpress.com/item/1005002212424250.html?gatewayAdapt=glo2deu&spm=a2g0o.9042311.0.0.dcd44c4deRtu6F             |
...
<!--
TODO: This could be part of a future version...
# Known Complications
What you might see and do then:

A channel shows RAILED or very low (<5 uVrms) or high (>50 uVrms) amplitudes: This means the electrode does not have good contact with the skin. See if you can improve the contact between electrode and head (remove hair or twist the electrode a bit).
All channels show RAILED or bad amplitudes: This means that the reference electrode (the second one on the left ear) has poor contact.
You can see the video below to get an impression of what a recording should look like ideally:
-->